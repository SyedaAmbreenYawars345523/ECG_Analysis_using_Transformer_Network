...
from encoder_only_data_fetch import get_train_val_data
import numpy as np
import os
from pandas import *
...
def main():
    ...
    # first location for all ecg folder, second is just with /, thirs is for ground truth
    ...
    for epoch in range(start_epoch, epochs):
        ...
        save_checkpoint("parameter_encoder_13000", epoch, epochs_since_improvement, model, model_optimizer,
                         recent_loss, is_best)
